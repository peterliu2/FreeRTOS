...
/* The LED toggled to give an indication of the demo status. */
...
/*
 * The full demo includes some tests that execute from an interrupt context, and
 * the tick hook is used for this purpose.
 */
