...
typedef struct {
    ...
    __IO uint16_t INTCLEAR;          /**< 0x44 - Interrupt clear */
    __IO uint16_t INTSET;            /**< 0x46 - Interrupt set */
...
#define BC_INTEN_MASK                       (0x001f)  /**< Interrupt enable mask */
...
#define BC_INTFLAG_MASK                     (0x001f)  /**< Interrupt flag mask */
