...
uint32_t CPUUsageTick( void )
{
    ...
    ui32Value = MAP_TimerValueGet( g_pui32CPUUsageTimerBase[ g_ui32CPUUsageTimer ], TIMER_A );
    ...
    // value.
    ui32Usage = ( ( ( ( g_ui32CPUUsagePrevious - ui32Value ) * 6400 ) / g_ui32CPUUsageTicks ) * 1024 );
...
void CPUUsageInit(uint32_t ui32ClockRate, uint32_t ui32Rate, uint32_t ui32Timer)
{
    ...
    MAP_TimerConfigure( g_pui32CPUUsageTimerBase[ ui32Timer ], TIMER_CFG_PERIODIC );
