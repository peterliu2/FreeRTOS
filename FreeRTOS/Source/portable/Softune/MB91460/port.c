...
ST RP,@-R15								;
Store RP
STM0 (R7,R6,R5,R4,R3,R2,R1,R0)				;
Store R7-R0
STM1 (R14,R13,R12,R11,R10,R9,R8)			;
Store R14-R8
ST MDH, @-R15								;
Store MDH
ST MDL, @-R15								;
...
LD @R0, R0									;
Get the pxCurrentTCB->pxTopOfStack address
ST R15,@R0									;
...
CALL32	 _xTaskIncrementTick,R12		;
Increment Tick
CALL32	 _vTaskSwitchContext,R12		;
